  ...
  return (
    <div className = "mx-auto my-3 py-5 flex flex-col items-center justify-between bg-softgray text-bold rounded-lg">
      ...
      <h1 className = "text-fontLight text-lg px-9 text-center w-full">
        This visualization tool is an interactive online platform that is designed to help provide an engaging way to explore and understand different
        algorithms and data structures... should probs add some more text here... :(
      </h1>
    </div>
  )
}
